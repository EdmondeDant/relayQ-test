export default {
  ...
  admin: {
    ...
    accounts: {
	  ...
	  videoPromptPlaceholder: 'Example: A calm sunrise over a still lake with cinematic camera movement.',
	  videoPromptDefault: 'A calm sunrise over a still mountain lake, natural cinematic motion, no text, no people.',
	  videoTestHint: 'When a video model is selected, this sends a real video generation request and previews the returned video below.',
	  videoTestMode: 'Mode: Video generation test',
	  videoPreview: 'Generated videos:',
	  videoReceived: 'Received test video #{count}',
	  paidVideoTest: 'Paid Video Test',
	  paidVideoTestTitle: 'Confirm Paid Video Test',
	  paidVideoTestMessage: 'This sends a real 4-second 864×480 video generation request to Leonardo and may incur charges. Continue?',
	  confirmPaidVideoTest: 'Confirm and Generate Video',
	  submissionUnknownLocked: 'Status Unknown — Do Not Retry',
      // Stats Modal
