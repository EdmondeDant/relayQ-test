export default {
  ...
  admin: {
    ...
    accounts: {
	  ...
	  videoPromptPlaceholder: '例如：宁静湖面的日出，电影感镜头运动，无文字，无人物。',
	  videoPromptDefault: 'A calm sunrise over a still mountain lake, natural cinematic motion, no text, no people.',
	  videoTestHint: '选择视频模型后，这里会发起真实视频生成测试，并在下方展示返回视频。',
	  videoTestMode: '模式：视频生成测试',
	  videoPreview: '生成视频：',
	  videoReceived: '已收到第 {count} 个测试视频',
	  paidVideoTest: '付费视频测试',
	  paidVideoTestTitle: '确认付费视频测试',
	  paidVideoTestMessage: '该操作会向 Leonardo 发起真实的 4 秒 864×480 视频生成请求，并可能产生费用。是否继续？',
	  confirmPaidVideoTest: '确认并生成视频',
	  submissionUnknownLocked: '状态未知，请勿重试',
      // Stats Modal
      viewStats: '查看统计',
