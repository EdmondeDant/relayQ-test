...
export type Platform = 'anthropic' | 'openai' | 'antigravity' | 'gemini' | 'xai'
...
const BADGE: Record<Platform, string> = {
  ...
  xai: 'bg-slate-500/10 text-slate-600 border-slate-500/30 dark:text-slate-400',
}
...
const BADGE_LIGHT: Record<Platform, string> = {
  ...
  xai: 'bg-slate-500/10 text-slate-600 dark:bg-slate-500/10 dark:text-slate-300',
}
...
const BORDER: Record<Platform, string> = {
  ...
  xai: 'border-slate-500/20 dark:border-slate-500/20',
}
...
const ACCENT_BAR: Record<Platform, string> = {
  ...
  xai: 'bg-gradient-to-r from-slate-400 to-slate-500',
}
...
const TEXT: Record<Platform, string> = {
  ...
  xai: 'text-slate-600 dark:text-slate-400',
}
...
const ICON: Record<Platform, string> = {
  ...
  xai: 'text-slate-500 dark:text-slate-400',
}
...
const BUTTON: Record<Platform, string> = {
  ...
  xai: 'bg-slate-600 text-white hover:bg-slate-700 active:bg-slate-800 dark:bg-slate-600/80 dark:hover:bg-slate-600',
}
...
const DISCOUNT: Record<Platform, string> = {
  ...
  xai: 'bg-slate-100 text-slate-700 dark:bg-slate-900/40 dark:text-slate-300',
}
...
const GRADIENT: Record<Platform, string> = {
  ...
  xai: 'from-slate-500 to-slate-600',
}
...
function isPlatform(p: string): p is Platform {
  return p === 'anthropic' || p === 'openai' || p === 'antigravity' || p === 'gemini' || p === 'xai'
}
