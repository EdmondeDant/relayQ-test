...
const getOAuthKey = (key: string) => {
  ...
  if (props.platform === 'xai') return `admin.accounts.oauth.xai.${key}`
...
watch(authCodeInput, (newVal) => {
  if (props.platform !== 'openai' && props.platform !== 'xai' && props.platform !== 'gemini' && props.platform !== 'antigravity') return
  ...
  if (trimmed.includes('?') && trimmed.includes('code=')) {
    try {
      ...
      if ((props.platform === 'openai' || props.platform === 'xai' || props.platform === 'gemini' || props.platform === 'antigravity') && stateParam) {
      ...
      if ((props.platform === 'openai' || props.platform === 'xai' || props.platform === 'gemini' || props.platform === 'antigravity') && stateMatch && stateMatch[1]) {
