    ...
    groups: [
      {
        title: 'Windows',
        links: [
          createDownloadLink('Windows x64 MSI', 'cc-switch-windows-x64-msi', 'x64', 'MSI', 12386304, true),
          createDownloadLink('Windows x64 Portable ZIP', 'cc-switch-windows-x64-portable-zip', 'x64', 'ZIP', 12407588),
        ],
      },
      {
        title: 'macOS',
        links: [
          createDownloadLink('macOS Universal DMG', 'cc-switch-macos-universal-dmg', 'Universal', 'DMG', 25842794, true),
          createDownloadLink('macOS Universal ZIP', 'cc-switch-macos-universal-zip', 'Universal', 'ZIP', 25819382),
          createDownloadLink('macOS Universal TAR.GZ', 'cc-switch-macos-universal-tar-gz', 'Universal', 'TAR.GZ', 26458757),
        ],
      },
      {
        title: 'Linux',
        links: [
          createDownloadLink('Linux x64 DEB', 'cc-switch-linux-x64-deb', 'x64', 'DEB', 12489082, true),
          createDownloadLink('Linux ARM64 DEB', 'cc-switch-linux-arm64-deb', 'ARM64', 'DEB', 11993434),
          createDownloadLink('Linux x64 RPM', 'cc-switch-linux-x64-rpm', 'x64', 'RPM', 12489318),
          createDownloadLink('Linux ARM64 RPM', 'cc-switch-linux-arm64-rpm', 'ARM64', 'RPM', 11995647),
          createDownloadLink('Linux x64 AppImage', 'cc-switch-linux-x64-appimage', 'x64', 'AppImage', 91245048),
          createDownloadLink('Linux ARM64 AppImage', 'cc-switch-linux-arm64-appimage', 'ARM64', 'AppImage', 88881672),
        ],
      },
    ],
  },
