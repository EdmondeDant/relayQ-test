...
// The GenerationJobFunc type is an adapter to allow the use of ordinary
// function as GenerationJob mutator.
type GenerationJobFunc func(context.Context, *ent.GenerationJobMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f GenerationJobFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.GenerationJobMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.GenerationJobMutation", m)
}
...
// The IdeaMessageFunc type is an adapter to allow the use of ordinary
// function as IdeaMessage mutator.
type IdeaMessageFunc func(context.Context, *ent.IdeaMessageMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f IdeaMessageFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.IdeaMessageMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.IdeaMessageMutation", m)
}
