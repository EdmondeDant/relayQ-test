...
func (Group) Edges() []ent.Edge {
	return []ent.Edge{
		...
		edge.To("media_products", MediaProduct.Type).
			StorageKey(edge.Table("media_product_group_bindings"), edge.Columns("group_id", "product_id")),
		edge.To("media_source_offers", MediaOffer.Type),
