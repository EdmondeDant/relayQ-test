...
var (
	...
	GenerationJobsColumns = []*schema.Column{
		...
		{Name: "estimated_upstream_cost_amount", Type: field.TypeOther, Nullable: true, SchemaType: map[string]string{"postgres": "decimal(20,10)"}},
		...
		{Name: "gross_margin", Type: field.TypeOther, Nullable: true, SchemaType: map[string]string{"postgres": "decimal(20,10)"}},
		{Name: "cost_variance", Type: field.TypeOther, Nullable: true, SchemaType: map[string]string{"postgres": "decimal(20,10)"}},
