...
var (
	...
	GenerationJobsColumns = []*schema.Column{
		...
		{Name: "estimated_upstream_cost_amount", Type: field.TypeOther, Nullable: true, SchemaType: map[string]string{"postgres": "decimal(20,10)", "sqlite3": "numeric"}},
		{Name: "estimated_upstream_cost_unit", Type: field.TypeString, Nullable: true, Size: 32},
		{Name: "pricing_snapshot_version", Type: field.TypeString, Nullable: true, Size: 64},
		{Name: "pricing_source", Type: field.TypeString, Nullable: true, Size: 128},
		{Name: "pricing_match_type", Type: field.TypeString, Nullable: true, Size: 32},
		{Name: "actual_upstream_cost_amount", Type: field.TypeOther, Nullable: true, SchemaType: map[string]string{"postgres": "decimal(20,10)", "sqlite3": "numeric"}},
		{Name: "actual_upstream_cost_unit", Type: field.TypeString, Nullable: true, Size: 32},
		{Name: "customer_cost", Type: field.TypeOther, Nullable: true, SchemaType: map[string]string{"postgres": "decimal(20,10)", "sqlite3": "numeric"}},
		{Name: "gross_margin", Type: field.TypeOther, Nullable: true, SchemaType: map[string]string{"postgres": "decimal(20,10)", "sqlite3": "numeric"}},
		{Name: "cost_variance", Type: field.TypeOther, Nullable: true, SchemaType: map[string]string{"postgres": "decimal(20,10)", "sqlite3": "numeric"}},
	...
	UsageLogsColumns = []*schema.Column{
		...
		{Name: "audio_mode", Type: field.TypeString, Nullable: true, Size: 16},
		{Name: "audio_units", Type: field.TypeFloat64, Nullable: true, SchemaType: map[string]string{"postgres": "decimal(20,10)"}},
