...
func ProvideRouter(
	...
	retailGrokAuth middleware2.RetailGrokKeyAuthMiddleware,
	...
	return SetupRouter(r, handlers, jwtAuth, adminAuth, apiKeyAuth, retailGrokAuth, apiKeyService, subscriptionService, opsService, settingService, cfg, redisClient)
}
