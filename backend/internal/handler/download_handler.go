...
var downloadCatalog = map[string]DownloadAsset{
	"cc-switch-windows-x64-msi": {
		...
		Architecture:  "x64",
		PackageFormat: "MSI",
		FileName:      "CC-Switch-v3.16.5-Windows.msi",
		SizeBytes:     12386304,
		SourceURL:     "https://github.com/farion1231/cc-switch/releases/download/v3.16.5/CC-Switch-v3.16.5-Windows.msi",
	},
	"cc-switch-windows-x64-portable-zip": {
		...
		Architecture:  "x64",
		PackageFormat: "ZIP",
		FileName:      "CC-Switch-v3.16.5-Windows-Portable.zip",
		SizeBytes:     12407588,
		SourceURL:     "https://github.com/farion1231/cc-switch/releases/download/v3.16.5/CC-Switch-v3.16.5-Windows-Portable.zip",
	},
	"cc-switch-macos-universal-dmg": {
		...
		PackageFormat: "DMG",
		FileName:      "CC-Switch-v3.16.5-macOS.dmg",
		SizeBytes:     25842794,
		SourceURL:     "https://github.com/farion1231/cc-switch/releases/download/v3.16.5/CC-Switch-v3.16.5-macOS.dmg",
	},
	"cc-switch-macos-universal-zip": {
		...
		Architecture:  "Universal",
		PackageFormat: "ZIP",
		FileName:      "CC-Switch-v3.16.5-macOS.zip",
		SizeBytes:     25819382,
		SourceURL:     "https://github.com/farion1231/cc-switch/releases/download/v3.16.5/CC-Switch-v3.16.5-macOS.zip",
	},
	"cc-switch-macos-universal-tar-gz": {
		...
		FileName:      "CC-Switch-v3.16.5-macOS.tar.gz",
		SizeBytes:     26458757,
		SourceURL:     "https://github.com/farion1231/cc-switch/releases/download/v3.16.5/CC-Switch-v3.16.5-macOS.tar.gz",
	},
	"cc-switch-linux-x64-deb": {
		...
		Architecture:  "x64",
		PackageFormat: "DEB",
		FileName:      "CC-Switch-v3.16.5-Linux-x86_64.deb",
		SizeBytes:     12489082,
		SourceURL:     "https://github.com/farion1231/cc-switch/releases/download/v3.16.5/CC-Switch-v3.16.5-Linux-x86_64.deb",
	},
	"cc-switch-linux-arm64-deb": {
		...
		Architecture:  "ARM64",
		PackageFormat: "DEB",
		FileName:      "CC-Switch-v3.16.5-Linux-arm64.deb",
		SizeBytes:     11993434,
		SourceURL:     "https://github.com/farion1231/cc-switch/releases/download/v3.16.5/CC-Switch-v3.16.5-Linux-arm64.deb",
	},
	"cc-switch-linux-x64-rpm": {
		...
		Architecture:  "x64",
		PackageFormat: "RPM",
		FileName:      "CC-Switch-v3.16.5-Linux-x86_64.rpm",
		SizeBytes:     12489318,
		SourceURL:     "https://github.com/farion1231/cc-switch/releases/download/v3.16.5/CC-Switch-v3.16.5-Linux-x86_64.rpm",
	},
	"cc-switch-linux-arm64-rpm": {
		...
		Architecture:  "ARM64",
		PackageFormat: "RPM",
		FileName:      "CC-Switch-v3.16.5-Linux-arm64.rpm",
		SizeBytes:     11995647,
		SourceURL:     "https://github.com/farion1231/cc-switch/releases/download/v3.16.5/CC-Switch-v3.16.5-Linux-arm64.rpm",
	},
	"cc-switch-linux-x64-appimage": {
		...
		FileName:      "CC-Switch-v3.16.5-Linux-x86_64.AppImage",
		SizeBytes:     91245048,
		SourceURL:     "https://github.com/farion1231/cc-switch/releases/download/v3.16.5/CC-Switch-v3.16.5-Linux-x86_64.AppImage",
	},
	"cc-switch-linux-arm64-appimage": {
		...
		Architecture:  "ARM64",
		PackageFormat: "AppImage",
		FileName:      "CC-Switch-v3.16.5-Linux-arm64.AppImage",
		SizeBytes:     88881672,
		SourceURL:     "https://github.com/farion1231/cc-switch/releases/download/v3.16.5/CC-Switch-v3.16.5-Linux-arm64.AppImage",
	},
