...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	mediaFundsRepository := repository.NewMediaFundsRepository(db)
	...
	mediaOrchestrator := service.ProvideMediaOrchestrator(mediaCatalogService, generationJobRepository, accountRepository, mediaFundsService, mediaJobAttemptRepository, mediaUsageAuditService, mediaOpenAIAdapter, mediaLeonardoAdapter)
	mediaHandler := handler.NewMediaHandler(mediaCatalogService, mediaOrchestrator)
