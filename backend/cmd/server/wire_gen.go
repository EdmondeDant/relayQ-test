...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	authService := service.NewAuthService(client, userRepository, redeemCodeRepository, refreshTokenCache, configConfig, settingService, emailService, turnstileService, emailQueueService, promoService, subscriptionService, affiliateService, serviceUserPlatformQuotaRepository, redisClient)
	...
	openAIGatewayService.SetXAIOAuthService(xaiOAuthService)
	...
	gatewayService.SetXAIOAuthService(xaiOAuthService)
	...
	leonardoImageCreateOrchestrator := service.ProvideLeonardoImageCreateOrchestrator(leonardoImageQuoteGuard, leonardoImageFunds, accountRepository, leonardoImageAccountAdapterFactory, generationJobRepository)
	leonardoMediaCreateService := service.NewLeonardoMediaCreateService(accountRepository, leonardoImageCreateOrchestrator)
	generationJobPollRepository := service.ProvideGenerationJobPollRepository(generationJobRepository)
	leonardoGenerationPollClock := service.ProvideLeonardoGenerationPollClock()
	leonardoGenerationPollOrchestrator := service.ProvideLeonardoGenerationPollOrchestrator(generationJobPollRepository, accountRepository, httpUpstream, configConfig, leonardoGenerationPollClock)
